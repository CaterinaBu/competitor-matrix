...
const APPS_SCRIPT_URL: string | null = "https://script.google.com/macros/s/AKfycbx9_yPLlaHMeZ6NY7pTdjkDjxnz1kQqupOR7PW4G31pyIZpe1KiJyQxkioxQEX0kPjc/exec"; // WebApp для записи
